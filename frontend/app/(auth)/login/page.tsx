            ...
            <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12">
              <div className="_social_login_content">
                <div className="_social_login_left_logo _mar_b28">
                  <div className="_left_logo" style={{ fontSize: '24px', fontWeight: '800', color: '#1890FF', fontFamily: 'Poppins, sans-serif' }}>
                    BuddyScript
                  </div>
                </div>
                    ...
                    <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                      <div className="_social_login_form_input _mar_b14">
                        ...
                        <input
                          type="email"
                          name="email"
                          className={`form-control _social_login_input${state?.errors?.email ? ' is-invalid' : ''}`}
                    ...
                    <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                      <div className="_social_login_form_input _mar_b14">
                        ...
                        <input
                          type="password"
                          name="password"
                          className={`form-control _social_login_input${state?.errors?.password ? ' is-invalid' : ''}`}
                  ...
                  <div className="row">
                    <div className="col-lg-12 col-md-12 col-xl-12 col-sm-12">
                      <div className="_social_login_form_btn _mar_t40 _mar_b60">
                        <button type="submit" className="_social_login_form_btn_link _btn1" disabled={isPending}>
